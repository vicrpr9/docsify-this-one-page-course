...
5. Choose the page options you want (i.e. Table of Contents) and tap the **View as Standalone Page** button to view your Markdown file as a web page for sharing or embedding
