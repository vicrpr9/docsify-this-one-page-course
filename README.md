...
5. Select the page options you want (e.g. Table of Contents) and tap the **Publish as a Web Page** button to view your Markdown file as a web page for sharing or embedding
